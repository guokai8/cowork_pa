...
exp_ids <- lincs_sig_info$id[1:5000]
...
print("Top 50 perturbagen candidates:")
print(cmap_score_info[1:50,])
print("CMAP scores related to Palbociclib:")
print(cmap_score_info[cmap_score_info$exp_id %in% lincs_sig_info[lincs_sig_info$pert_iname == "palbociclib","id"],])
```
